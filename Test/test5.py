...
class OrbBasedFeatureMatcher:
    def __init__(self, max_hamming_distance=64):
    ...
    def match(self, keyframe, frame):
        ...
        matches = [m for m in bf.match(des1, des2) if m.distance < self.max_hamming_distance]
        return matches, kp1, kp2

class Frontend:
    def __init__(self, cam_specs, min_matches=15, max_error=0.03, outlier_margin=0.005):
...
def main(video_file):
    ...
    frontend = Frontend(cam_specs, min_matches=15, max_error=0.03, outlier_margin=0.005)
...
if __name__ == "__main__":
    video_file = "/home/zlabs/Desktop/test2.mp4"  # Change this to your video file path
    main(video_file)
